...
class Agent():
    ...
    def __init__(self, BATCH_SIZE, MEMORY_SIZE, GAMMA, output_dim, action_dim, action_dict, EPS_START, EPS_END, lr, TAU, OBSERVE, EXPLORE) -> None:
        ...
        self.policy_net = model.MonsterNetv2(input_dim=4, output_dim=self.output_dim).to(self.device)
        self.target_net = model.MonsterNetv2(input_dim=4, output_dim=self.output_dim).to(self.device)
